...
#ifndef INDUSTRIAL_TURTLE__MSG__DETAIL__ROBOT_STATUS__FUNCTIONS_H_
#define INDUSTRIAL_TURTLE__MSG__DETAIL__ROBOT_STATUS__FUNCTIONS_H_
 ...
 * calls
 * industrial_turtle__msg__RobotStatus__init().
...
/**
 * It calls
 * industrial_turtle__msg__RobotStatus__fini()
 ...
 * industrial_turtle__msg__RobotStatus__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * industrial_turtle__msg__RobotStatus__Sequence__fini()
 * on the array,
...
#endif  // INDUSTRIAL_TURTLE__MSG__DETAIL__ROBOT_STATUS__FUNCTIONS_H_

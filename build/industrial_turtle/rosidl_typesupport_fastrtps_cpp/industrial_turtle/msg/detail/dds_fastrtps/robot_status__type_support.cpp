...
#include "industrial_turtle/msg/detail/robot_status__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = industrial_turtle::msg::RobotStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const industrial_turtle::msg::RobotStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<industrial_turtle::msg::RobotStatus *>(
    untyped_ros_message);
...
{
  return &industrial_turtle::msg::typesupport_fastrtps_cpp::_RobotStatus__handle;
}
